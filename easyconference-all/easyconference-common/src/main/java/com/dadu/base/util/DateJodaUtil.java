 ...
 * @author SoYon Lim
 * @author JongHoon Kim
 * @author HyunJung Jeong reference :
 *         http://dev.anyframejava.org/docs/anyframe/plugin
 *         /optional/util-demo/1.0
 *         .0/reference/htmlsingle/util-demo.html#utildemo_utildemo_part main :
...
public class DateJodaUtil {
	 ...
	 *            the Date to compare with.
	 * @param date2
	 *            the other Date String to compare with. (The format equals
	 ...
	 *            Date to be compared.
	 * @param date2
	 *            another Date String to be compared. (The format equals
	 *            date2format that input argument)
	 * @param date2format
	 *            String date format
	 ...
	 * 
	 * @param str
	 *            the String Date to be converted (The format equals format that
	 *            input argument)
	 * @param format
	 ...
	 * 
	 * @param date
	 *            the Date to be converted (The format equals format that input
	 *            argument)
	 * @param format
	 *            Date format
	...
	public static Calendar string2Calender(String str) {
		...
		return (new GregorianCalendar(StringUtil.string2integer(year), StringUtil.string2integer(month) - 1,
				StringUtil.string2integer(day), StringUtil.string2integer(hour), StringUtil.string2integer(minute),
				StringUtil.string2integer(second)));
	}
